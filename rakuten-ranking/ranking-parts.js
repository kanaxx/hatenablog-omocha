// author kanaxx.
  const r10AffConfig = document.getElementById('rakuten-aff-config');
  const r10AffParts = document.getElementById('rakuten-aff-parts');
  const r10ApiUrl = 'https://app.rakuten.co.jp/services/api/IchibaItem/Ranking/20170628?format=json&formatVersion=2';
  const defaultConfig = {period:"realtime", display:5, applicationId:"1027300763038019149", affiliateId:"04021205.0d23044c.04021206.437bb859"};
